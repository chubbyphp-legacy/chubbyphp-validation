...
/**
 * @covers \Chubbyphp\ValidationModel\Constraint\ModelCollectionConstraint
 */
final class ModelCollectionConstraintTest extends TestCase
{
    public function testWithInvalidInputExceptException()
    {
        ...
        self::expectExceptionMessage(
            'Invalid input, instance of Chubbyphp\Model\Collection\ModelCollectionInterface needed'
        );
    ...
    public function testWithoutMinAndMax()
    {
        ...
        self::assertEquals(
            ...
            $constraint->validate(
                'modelCollection',
                $this->getModelCollection([$this->getModel()]),
                $this->getValidator([[]])
            )
        );
    }
    ...
    public function testWithMinAndMaxToManyValues()
    {
        ...
        self::assertEquals(
            ...
            $constraint->validate(
                'modelCollection',
                $this->getModelCollection([$this->getModel(), $this->getModel(), $this->getModel()]),
                $this->getValidator([[], [], []])
            )
        );
    }
    ...
    private function getModelCollection(array $models): ModelCollectionInterface
    {
        ...
        $modelCollection = $this
            ...
            ->setMethods(['count', 'getModels'])
            ->getMockForAbstractClass()
        ;

        $modelCollection->expects(self::any())->method('count')->willReturn(count($models));
        $modelCollection->expects(self::any())->method('getModels')->willReturn($models);

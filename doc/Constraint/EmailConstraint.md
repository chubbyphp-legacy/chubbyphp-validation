...
$errors = $constraint->validate('path.to.property', 'firstname.lastname@domain.tld', $context);
// [];
...
// [new Error('path.to.property', 'constraint.email.invalidformat', ['value' => 'email'])];
```
